...
def display_education_section():
    ...
    with st.expander("What are Bitcoin ETFs?"):
        st.write("""
        Bitcoin ETFs (Exchange-Traded Funds) are investment vehicles that track the price of Bitcoin and trade on traditional stock exchanges. They allow investors to gain exposure to Bitcoin without directly owning the cryptocurrency.
    ...
    with st.expander("Understanding On-Chain Metrics"):
        st.write("""
        On-chain metrics are measurements of activity occurring on the Bitcoin blockchain. They provide insights into network usage and health.
